...
- `src/app/` -> shell and route configuration
- `src/components/` -> shared UI primitives
- `src/features/` -> feature folders (`products`, `orders`, etc.)
...
Use `docs/ROADMAP.md` for the full phase sequence and done criteria.
